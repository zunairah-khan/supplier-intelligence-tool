...
const TierMap = ({ data }) => {
  ...
  useEffect(() => {
    ...
    //Apply translation for auto-centering
    g.attr(
      "transform",
    ...
    //Set initial transform based on auto-centering offsets
    const initialTransform = d3.zoomIdentity
      .translate(margin.left + offsetX, margin.top + offsetY)
      .scale(1);

    svg.call(zoom).call(zoom.transform, initialTransform); // Set initial position and zoom level
