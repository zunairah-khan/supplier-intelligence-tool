...
const TaskDialog = ({ task }) => {
 ...
 const { user } = useSelector((state) => state.auth);
  ...
  return (
    ...
    <AddTask open={openEdit} setOpen={setOpenEdit} task={task} key={new Date().getTime()} /> {/*key is used to force remounting of the component when task changes, so that the form is reset with new task data*/}
    <AddSubTask open={open} setOpen={setOpen} />
    <ConfirmationDialog open={openDialog} setOpen={setOpenDialog} msg={"Are you sure you want to delete this task?"} onConfirm={()=> deleteClicks()}/>
